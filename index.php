...
<div class="container">
    ...
    <?php if ($_SERVER["REQUEST_METHOD"] === "POST"): ?>
        ...
        define("PYTHON_SCRIPT", "/var/www/mecodify/xscraper/xscraper.py");
	...
	$script_arg = $uploadedFileName;
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $output = [];
            $return_var = 0;
            exec("/usr/bin/python3 " . escapeshellarg(PYTHON_SCRIPT) . " ".escapeshellarg($script_arg)." 2>&1", $output, $return_var);
